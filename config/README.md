...
### Get to know about all these vars in depth from our Docs. [Read Now from Here](https://notreallyshikhar.gitbook.io/BlackSoulbot/config-vars/available-vars)
...
4. `MONGO_DB_URI` : Get mongo db [from here.](https://notreallyshikhar.gitbook.io/BlackSoulbot/deployment/mongodb)
...
### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/BlackSoulbot/deployment/spotify)
...
### How to get these? [Read from here](https://notreallyshikhar.gitbook.io/BlackSoulbot/config-vars/heroku-vars)
